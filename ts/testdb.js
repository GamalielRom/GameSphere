...
function testCRUD() {
    return __awaiter(this, void 0, void 0, function () {
        var companyId, companies, company, companiesAfterDeletion, error_3;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 6, , 7]);
                    return [4 /*yield*/, (0, CRUD_1.createCompany)({ company_name: 'Rockstar' })];
                case 1:
                    companyId = _a.sent();
                ...
                case 2:
                    ...
                    return [4 /*yield*/, (0, CRUD_1.getCompanyByID)(2)];
                case 3:
                    company = _a.sent();
                    console.log('Company by ID:', company);
                    // DELETE: Eliminar la compañía
                    return [4 /*yield*/, (0, CRUD_1.deleteCompanyByID)(2)];
                case 4:
                    // DELETE: Eliminar la compañía
                    _a.sent();
                    console.log("Company with ID ".concat(companyId, " deleted."));
                    return [4 /*yield*/, (0, CRUD_1.getAllCompanies)()];
                case 5:
