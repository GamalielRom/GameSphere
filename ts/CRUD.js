        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    values = Object.values(Videogame);
...
function deleteVideogameByID(id) {
    return __awaiter(this, void 0, void 0, function () {
        var db, videogameExist, query, result, error_5;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, , 5]);
                ...
                case 3:
                    result = _a.sent();
                    if (result.changes === 0) {
                        throw new Error("Failed to delete the videogame with the id of ".concat(id));
                    }
...
//GENRES TABLE 
// Add Genre 
function createGenre(game_genre) {
    return __awaiter(this, void 0, void 0, function () {
        var db, existingGenre, query, result, error_6;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, , 5]);
                ...
                case 1:
                    db = _a.sent();
                    return [4 /*yield*/, db.get("SELECT 1 FROM Genres WHERE game_genre = ?", [game_genre])];
                case 2:
                    existingGenre = _a.sent();
                    if (existingGenre) {
                        throw new Error("Genre \"".concat(game_genre, "\" already exists"));
                    }
                    query = "\n            INSERT INTO Genres\n                (game_genre)\n            VALUES (?);\n            ";
                    return [4 /*yield*/, db.run(query, [game_genre])];
                case 3:
                    result = _a.sent();
                    console.log('Genre added successfully');
                    return [2 /*return*/, { id: result.lastID, game_genre: game_genre }];
                case 4:
                    error_6 = _a.sent();
                    if (error_6.message.includes('already existis')) {
...
function updateGenreByID(id, updates) {
    return __awaiter(this, void 0, void 0, function () {
        var db, genreExist, query, result, error_9;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, , 5]);
                ...
                case 2:
                    ...
                    query = "UPDATE Genres SET game_genre =? WHERE id = ?;";
                    return [4 /*yield*/, db.run(query, [updates.game_genre])];
                case 3:
                    result = _a.sent();
                    if (result.changes === 0) {
                        return [2 /*return*/, null];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    db = _a.sent();
                    return [2 /*return*/, db.all("Select * FROM Plataforms")];
                case 2:
                    error_11 = _a.sent();
                    console.log('Error reading the table', error_11.message);
                    return [3 /*break*/, 3];
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    db = _a.sent();
                    return [2 /*return*/, db.get("SELECT * FROM Plataforms WHERE id = ?;")];
                case 2:
                    error_12 = _a.sent();
                    console.error("The id: ".concat(id, " does not exist"));
                    return [3 /*break*/, 3];
                case 3: return [2 /*return*/];
            }
        });
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    error_13 = _a.sent();
                    console.error('Cant add the user please try again', error_13.message);
                    return [3 /*break*/, 4];
                case 4: return [2 /*return*/];
            }
        });
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    error_15 = _a.sent();
                    console.error('Impossible to find this user', error_15.message);
                    return [2 /*return*/, []];
                case 4: return [2 /*return*/];
            }
        });
...
function updateUserByID(id, updates) {
    return __awaiter(this, void 0, void 0, function () {
        var db, genreExist, fields, values, query, error_16;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, , 5]);
                ...
                case 4:
                    error_16 = _a.sent();
                    console.error('Error updating the user:', error_16.message);
                    return [3 /*break*/, 5];
                case 5: return [2 /*return*/];
            }
        });
...
function deleteUserById(id) {
    return __awaiter(this, void 0, void 0, function () {
        var db, userExist, query, error_17;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, , 5]);
                ...
                case 4:
                    error_17 = _a.sent();
                    console.error('Error deleting the User:', error_17.message);
                    return [3 /*break*/, 5];
                case 5: return [2 /*return*/];
            }
        });
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    error_18 = _a.sent();
                    console.error('Impossible to add this review', error_18.message);
                    return [3 /*break*/, 4];
                case 4: return [2 /*return*/];
            }
        });
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    error_19 = _a.sent();
                    console.error('Impossible to read all reviews', error_19.message);
                    return [2 /*return*/, []];
                case 4: return [2 /*return*/];
            }
        });
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    error_20 = _a.sent();
                    console.error('Impossible to find this review', error_20.message);
                    return [2 /*return*/, []];
                case 4: return [2 /*return*/];
            }
        });
...
function updateReviewByID(id, updates) {
    return __awaiter(this, void 0, void 0, function () {
        var db, fields, values, query, error_21;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                ...
                case 3:
                    error_21 = _a.sent();
                    console.error('Error updating the Review', error_21.message);
                    return [3 /*break*/, 4];
                case 4: return [2 /*return*/];
            }
        });
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    error_22 = _a.sent();
                    console.error('Impossible to remove this record', error_22.message);
                    return [3 /*break*/, 4];
                case 4: return [2 /*return*/];
            }
        });
...
function createCompany(company) {
    return __awaiter(this, void 0, void 0, function () {
        var db, query, values, result, error_23;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                ...
                case 3:
                    error_23 = _a.sent();
                    if (error_23.message.includes('UNIQUE constraint failed')) {
                        console.error('The company name already exists');
                    }
                    else {
                        console.error('Impossible to add this company', error_23.message);
                    }
                    return [3 /*break*/, 4];
                case 4: return [2 /*return*/];
            }
...
function getAllCompanies() {
    return __awaiter(this, void 0, void 0, function () {
        var db, query, companies, error_24;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                ...
                case 3:
                    error_24 = _a.sent();
                    console.error('Impossible to read all companies', error_24.message);
                    return [2 /*return*/, []];
                case 4: return [2 /*return*/];
            }
        });
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    error_25 = _a.sent();
                    console.error('Impossible to find this review', error_25.message);
...
function updateCompanyByID(id, updates) {
    return __awaiter(this, void 0, void 0, function () {
        var db, companyExist, fields, values, query, result, error_26;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, , 5]);
                ...
                case 4:
                    error_26 = _a.sent();
                    console.error('Error updating the Company', error_26.message);
...
function deleteCompanyByID(id) {
    return __awaiter(this, void 0, void 0, function () {
        var db, companyExist, query, result, error_27;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 4, , 5]);
                ...
                case 4:
                    error_27 = _a.sent();
                    console.error('Impossible to remove this record', error_27.message);
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    error_28 = _a.sent();
                    console.error('Error linking videogame to the plataform', error_28.message);
                    return [3 /*break*/, 5];
                case 5: return [2 /*return*/];
            }
        });
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    error_29 = _a.sent();
                    console.error('ERROR fetching Videogames for PLataforms', error_29.message);
                    return [2 /*return*/, []];
                case 5: return [2 /*return*/];
            }
        });
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    error_30 = _a.sent();
                    console.error('Error unlinking videogame from platform', error_30.message);
                    return [3 /*break*/, 5];
                case 5: return [2 /*return*/];
            }
        });
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    error_31 = _a.sent();
                    console.error('Error adding this videogame to favorite list please try again later', error_31.message);
                    return [3 /*break*/, 5];
                case 5: return [2 /*return*/];
            }
        });
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    error_32 = _a.sent();
                    console.error('Error reading the favorites for user', error_32.message);
                    return [2 /*return*/, []];
                case 5: return [2 /*return*/];
            }
        });
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    error_33 = _a.sent();
                    console.error('Error removing videogame from user favorites list', error_33.message);
                    return [3 /*break*/, 5];
                case 5: return [2 /*return*/];
            }
        });
    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    error_34 = _a.sent();
                    console.error('Error adding the genre to this videogame', error_34.message);
                    return [3 /*break*/, 5];
                case 5: return [2 /*return*/];
            }
        });
